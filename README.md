...
- **兩層折疊，畫面乾淨**：任務清單分「天」和「景點」兩層折疊。天的標題列顯示日期、景點數、當天完成進度、天氣摘要。預設展開規則很聰明：進行中只展開今天、還沒到或已過去的日子收起、尚未開始只展開第 1 天、全部完成後全收。手動展開/收合會記住（依旅程與日期）。有「全部展開 / 全部收合」小工具。收合整天時裡面景點的展開狀態會保留。
